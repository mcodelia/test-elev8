...
const enCopy: Record<string, string> = {
  ...
  "Conectamos estrategia, creatividad y tecnología para construir empresas más sólidas.": "We connect strategy, creativity and technology to build stronger companies.",
  "Elev8 existe para convertir complejidad en dirección.": "Elev8 exists to turn complexity into direction.",
  "Un estudio para marcas que necesitan claridad, criterio y ejecución en un mismo lugar.": "A studio for brands that need clarity, judgment and execution in one place.",
  "Una entrada para ordenar lo visual, lo digital, lo operativo y lo físico bajo una misma intención.": "One entry point to align visual, digital, operational and physical work under one intention.",
  "Una dirección.": "One direction.",
  "Pensar antes de producir": "Think before producing",
  "Diseñar para decidir": "Design to decide",
  "Construir sistemas": "Build systems",
  "Reducir fricción": "Reduce friction",
  "Crear continuidad": "Create continuity",
  "Primero el problema. Luego la forma.": "First the problem. Then the form.",
  "El método debe entenderse en segundos. Mirar, ordenar, construir, mejorar.": "The method should land in seconds. Look, clarify, build, improve.",
  "Encontramos el bloqueo real.": "We find the real blocker.",
  "Definimos qué mover primero.": "We define what moves first.",
  "Damos forma a la decisión.": "We shape the decision.",
  "Llevamos la idea al mundo.": "We bring the idea into the world.",
  "Dejamos una base para crecer.": "We leave a base for growth.",
  "Un ecosistema. Cinco formas de entrar.": "One ecosystem. Five ways in.",
  "Separadas cuando conviene. Conectadas cuando el negocio lo pide.": "Separate when useful. Connected when the business needs it.",
  "Dirección antes de producir.": "Direction before production.",
  "Percepción clara y reconocible.": "Clear, recognizable perception.",
  "Sitios y productos que orientan.": "Sites and products that guide.",
  "Menos fricción. Más sistema.": "Less friction. More system.",
  "La marca fuera de la pantalla.": "The brand beyond the screen.",
  "Explorar": "Explore",
  "Elige por dónde empezar.": "Choose where to start.",
  "Cada ruta abre una conversación distinta. Lanzar, mejorar, integrar, optimizar o materializar.": "Each path opens a different conversation. Launch, improve, integrate, optimize or materialize.",
  "Para salir al mercado con claridad.": "For entering the market with clarity.",
  "Para verse al nivel de lo que ya eres.": "To look like the company you already are.",
  "Para ordenar marca, web, operación y experiencia.": "To align brand, web, operations and experience.",
  "Para equipos que necesitan trabajar mejor.": "For teams that need to work better.",
  "Para hacer visible la marca en el mundo real.": "To make the brand visible in the real world.",
  "Descubrir ruta": "Discover path",
  "Explorar ruta": "Explore path",
  "Ver solución": "View solution",
  "Conocer ruta": "See path",
  "Encuentra tu puerta de entrada.": "Find your entry point.",
  "Si reconoces una frase, ya tienes una ruta.": "If one line feels familiar, you already have a path.",
  "Decisiones": "Decisions",
  "Menos ruido. Mejores movimientos.": "Less noise. Better moves.",
  "Antes de producir más piezas, conviene saber qué decisión falta.": "Before producing more pieces, know what decision is missing.",
  "Decisión 01": "Decision 01",
  "Decisión 02": "Decision 02",
  "Decisión 03": "Decision 03",
  "Decisión 04": "Decision 04",
  "Qué no está funcionando.": "What is not working.",
  "Qué cambia primero.": "What changes first.",
  "Qué pieza mueve el negocio.": "What piece moves the business.",
  "Cuál es el próximo paso.": "What the next step is.",
};
