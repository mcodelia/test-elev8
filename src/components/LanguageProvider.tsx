...
const enCopy: Record<string, string> = {
  ...
  "Cinco capacidades. Un solo sistema.": "Five capabilities. One system.",
  "El ecosistema Elev8 conecta criterio, diseño, tecnología y ejecución.": "The Elev8 ecosystem connects judgment, design, technology and delivery.",
  "Servicios presenta lo que sabemos construir. Las soluciones explican cuándo y por qué usarlo.": "Services show what we can build. Solutions explain when and why to use it.",
  "Capacidades independientes. Mejor resultado cuando trabajan conectadas.": "Independent capabilities. Better outcomes when they work together.",
  "El sistema se entiende por sus partes.": "The system is understood through its parts.",
  "Cada capacidad tiene una función clara. Juntas forman una base para construir con continuidad.": "Each capability has a clear role. Together, they create a foundation for continuity.",
  "Una lectura rápida. Para profundizar, entra en cada capacidad.": "A quick read. To go deeper, enter each capability.",
  "Define dirección, prioridades y marco de crecimiento.": "Defines direction, priorities and growth framework.",
  "Ver estrategia": "View strategy",
  "Da forma a identidad, discurso y presencia visual.": "Shapes identity, messaging and visual presence.",
  "Explorar capacidad": "Explore capability",
  "Construye sitios, productos e interfaces claras.": "Builds clear sites, products and interfaces.",
  "Conocer capacidad": "See capability",
  "Conecta automatización, IA, datos y sistemas.": "Connects automation, AI, data and systems.",
  "Descubrir más": "Discover more",
  "Lleva la identidad a espacios, soportes y puntos reales.": "Brings identity into spaces, supports and real touchpoints.",
  "Explorar servicio": "Explore service",
  "Qué hace cada capacidad.": "What each capability does.",
  "Sin metodología completa. Sólo el rol de cada pieza dentro del sistema.": "No full methodology here. Just the role of each piece inside the system.",
  "Ordena decisiones antes de diseñar o construir.": "Clarifies decisions before design or build.",
  "Prioridades": "Priorities",
  "Convierte criterio en identidad, voz y sistema visual.": "Turns judgment into identity, voice and visual system.",
  "Voz": "Voice",
  "Diseña presencia digital, interfaces y plataformas.": "Designs digital presence, interfaces and platforms.",
  "Interfaces": "Interfaces",
  "Plataformas": "Platforms",
  "Transforma procesos repetitivos en flujos conectados.": "Turns repetitive work into connected flows.",
  "Materializa identidad en espacios y soportes concretos.": "Materializes identity in concrete spaces and supports.",
  "Las capacidades se complementan.": "Capabilities work together.",
  "Identidad y experiencia digital trabajando como una sola capa.": "Identity and digital experience working as one layer.",
  "Estrategia, automatización y datos conectando decisiones internas.": "Strategy, automation and data connecting internal decisions.",
  "Marca aplicada con continuidad fuera de la pantalla.": "Brand applied with continuity beyond the screen.",
  "Profundiza en una capacidad.": "Go deeper into one capability.",
  "Cada área tiene metodología, entregables y ejemplos propios.": "Each area has its own method, deliverables and examples.",
  "Entra por el problema. Sal con una ruta.": "Enter through the problem. Leave with a path.",
  "Entra por el problema. Sal con una": "Enter through the problem. Leave with a ",
  "ruta.": "path.",
  "Nadie llega buscando una lista. Llega con algo que necesita cambiar.": "Nobody arrives looking for a list. They arrive with something that needs to change.",
  "Esta página ordena ese cambio: lanzar, modernizar, automatizar, renovar o alinear todo el recorrido.": "This page organizes that change: launch, modernize, automate, renew or align the full journey.",
  "Elige la situación que más se parece a la tuya. Desde ahí empezamos mejor.": "Choose the situation that feels closest to yours. That gives us a better start.",
  "Cada decisión abre una ruta.": "Every decision opens a path.",
  "La pregunta no es qué contratar. La pregunta es qué necesitas resolver primero.": "The question is not what to hire. It is what you need to solve first.",
  "Salir con claridad": "Leave with clarity",
  "Cuando hay una idea, pero falta estructura para lanzarla.": "When there is an idea, but no structure to launch it.",
  "Conocer la ruta": "See the path",
  "Verse al nivel correcto": "Look at the right level",
  "Cuando la empresa funciona, pero no se percibe así.": "When the company works, but is not perceived that way.",
  "Explorar decisión": "Explore the decision",
  "Ordenar todo el recorrido": "Align the full journey",
  "Cuando todo existe, pero nada conversa bien entre sí.": "When everything exists, but nothing works together clearly.",
  "Trabajar con menos fricción": "Work with less friction",
  "Cuando el equipo pierde tiempo en tareas repetidas.": "When the team loses time on repeated tasks.",
  "Resolver operación": "Solve operations",
  "Hacer visible la marca": "Make the brand visible",
  "Cuando la experiencia física no refleja el estándar del negocio.": "When the physical experience does not reflect the business standard.",
  "Cinco entradas. Cinco decisiones.": "Five entries. Five decisions.",
  "Cada una conduce a una página específica. Sin pasar por una lista de servicios.": "Each one leads to a specific page. No service list required.",
  "De idea suelta a salida clara al mercado.": "From loose idea to clear market launch.",
  "De presencia antigua a percepción alineada.": "From outdated presence to aligned perception.",
  "De operación manual a flujo conectado.": "From manual operation to connected flow.",
  "De espacio neutro a presencia reconocible.": "From neutral space to recognizable presence.",
  "De piezas aisladas a recorrido coherente.": "From isolated pieces to coherent journey.",
  "Si esto te pasa, entra por aquí.": "If this sounds familiar, start here.",
  "Menos diagnóstico mental. Más punto de partida.": "Less mental diagnosis. More starting point.",
  "Tengo una idea y necesito salir bien al mercado.": "I have an idea and need to enter the market well.",
  "Modernizar": "Modernize",
  "Renovar espacio": "Renew space",
  "Qué está pasando.": "What is happening.",
  "Miramos el problema antes de producir.": "We look at the problem before producing.",
  "Definir": "Define",
  "Qué debe cambiar.": "What must change.",
  "Convertimos la necesidad en ruta.": "We turn the need into a path.",
  "Qué se materializa.": "What gets materialized.",
  "Creamos sólo lo que empuja el resultado.": "We build only what moves the outcome.",
  "Qué queda listo.": "What remains ready.",
  "Dejamos una base para seguir avanzando.": "We leave a base to keep moving.",
  "Una solución no se arma por piezas. Se arma por continuidad.": "A solution is not assembled from pieces. It is built through continuity.",
  "Explora la ruta que más se parece a tu problema.": "Explore the path closest to your problem.",
  "Cada página profundiza en señales, escenarios y próximos pasos.": "Each page goes deeper into signals, scenarios and next steps.",
  "Existimos para convertir complejidad en dirección.": "We exist to turn complexity into direction.",
  "Existimos para convertir complejidad en": "We exist to turn complexity into ",
  "Elev8 ayuda a tomar mejores decisiones antes de construir.": "Elev8 helps teams make better decisions before building.",
  "Cuando una empresa crece, las piezas se separan. Nuestro trabajo es volver a darles sentido.": "As a company grows, its pieces drift apart. Our job is to make them make sense again.",
  "Criterio para construir mejor.": "Judgment to build better.",
  "Quiénes somos, cómo pensamos y cómo trabajamos cuando el problema todavía no viene ordenado.": "Who we are, how we think and how we work when the problem is not yet organized.",
  "Cómo pensamos": "How we think",
  "Siguiente paso": "Next step",
  "Dirección + criterio + proceso": "Direction + judgment + process",
  "Conocer Elev8": "Get to know Elev8",
  "No nacimos para producir más. Nacimos para ordenar mejor.": "We were not built to produce more. We were built to bring order.",
  "Elev8 existe para problemas que no se resuelven con una pieza aislada.": "Elev8 exists for problems that cannot be solved with one isolated piece.",
  "Muchas empresas crecen más rápido que su relato. Lo visual, lo digital, lo operativo y lo físico empiezan a ir por caminos distintos.": "Many companies grow faster than their story. Visual, digital, operational and physical layers start moving in different directions.",
  "Ahí aparece nuestro rol: mirar el conjunto, tomar decisiones y construir con intención.": "That is where we come in: see the whole, make decisions and build with intention.",
  "No partimos desde una lista de entregables. Partimos desde lo que impide avanzar.": "We do not start from a deliverables list. We start from what is blocking progress.",
  "Después definimos qué construir, qué dejar fuera y qué debe quedar preparado para crecer.": "Then we define what to build, what to leave out and what must be ready to grow.",
  "Menos reacción.": "Less reaction.",
  "Más criterio, más claridad, más dirección.": "More judgment, more clarity, more direction.",
  "Cuatro principios simples. No teoría. Decisiones.": "Four simple principles. Not theory. Decisions.",
  "Criterio antes que producción.": "Judgment before production.",
  "No todo problema necesita más piezas.": "Not every problem needs more pieces.",
  "Dirección antes que velocidad.": "Direction before speed.",
  "Avanzar rápido no sirve si se avanza torcido.": "Moving fast does not help if the direction is wrong.",
  "Claridad antes que volumen.": "Clarity before volume.",
  "Continuidad antes que campaña.": "Continuity before campaign.",
  "Lo que se construye debe poder crecer.": "What gets built must be able to grow.",
  "Lo suficiente para avanzar con foco. El detalle aparece en la conversación.": "Enough to move with focus. The details appear in conversation.",
  "Escuchamos el contexto y el problema real.": "We listen to the context and the real problem.",
  "Definimos prioridades y una ruta concreta.": "We define priorities and a concrete path.",
  "Convertimos dirección en forma y experiencia.": "We turn direction into form and experience.",
  "Llevamos la solución a producción.": "We take the solution into production.",
  "Cuéntanos qué estás construyendo.": "Tell us what you are building.",
  "Veamos si podemos ayudarte a darle dirección.": "Let us see if we can help give it direction.",
  "Correo": "Email",
  "Base": "Base",
  "Entrada": "Entry",
  "Las mejores decisiones empiezan con mejores preguntas.": "Better decisions start with better questions.",
  "Las mejores decisiones empiezan con mejores": "Better decisions start with better ",
  "preguntas.": "questions.",
  "Ideas, casos y guías para entender antes de invertir.": "Ideas, cases and guides to understand before investing.",
  "Menos teoría. Más señales concretas para decidir qué cambiar, qué priorizar y qué construir.": "Less theory. More concrete signals to decide what to change, prioritize and build.",
  "Empieza por una pregunta. Termina con una ruta más clara.": "Start with a question. End with a clearer path.",
  "Preguntas reales": "Real questions",
  "Casos útiles": "Useful cases",
  "Guías prácticas": "Practical guides",
  "Decisiones claras": "Clear decisions",
  "Selección editorial": "Editorial selection",
  "Dos lecturas para empezar.": "Two reads to start.",
  "Una para mirar la percepción. Otra para mirar la operación.": "One for perception. One for operations.",
  "Artículo destacado": "Featured article",
  "¿Por qué una buena empresa sigue pareciendo amateur?": "Why does a good company still look amateur?",
  "Señales de marca, web y comunicación que reducen confianza antes de la primera conversación.": "Brand, web and communication signals that reduce trust before the first conversation.",
  "Caso destacado": "Featured case",
  "Cómo reducir 18 horas semanales de trabajo manual.": "How to reduce 18 hours of manual work per week.",
  "Un problema operativo común: tareas repetidas, información dispersa y equipos persiguiendo datos.": "A common operational problem: repeated tasks, scattered information and teams chasing data.",
  "Ver el caso": "View case",
  "Artículos recientes": "Recent articles",
  "Problemas que conviene mirar temprano.": "Problems worth spotting early.",
  "Títulos pensados para resolver dudas, no para llenar una biblioteca.": "Titles built to answer questions, not fill a library.",
  "¿Cómo saber si tu identidad ya quedó chica?": "How do you know if your identity has become too small?",
  "Resolver": "Solve",
  "Qué revisar antes de rediseñar una página profesional.": "What to review before redesigning a professional website.",
  "Aplicar": "Apply",
  "Cuándo automatizar procesos sin sobrediseñar.": "When to automate processes without overdesigning.",
  "Herramientas para decidir con más calma.": "Tools to decide with more calm.",
  "Entradas prácticas para ordenar una conversación antes de pedir una propuesta.": "Practical entries to organize a conversation before asking for a proposal.",
  "Cómo lanzar una marca desde cero.": "How to launch a brand from scratch.",
  "Una guía para pasar de idea abierta a presencia mínima viable.": "A guide to move from open idea to minimum viable presence.",
  "Cómo modernizar una empresa sin empezar de cero.": "How to modernize a company without starting over.",
  "Qué conservar, qué corregir y qué ordenar primero.": "What to keep, what to fix and what to organize first.",
  "Cómo elegir una plataforma web.": "How to choose a web platform.",
  "Preguntas prácticas antes de invertir en diseño o tecnología.": "Practical questions before investing in design or technology.",
  "Si esta pregunta aparece, hay algo que mirar.": "If this question appears, there is something to look at.",
  "Recursos existe para convertir dudas vagas en decisiones más concretas.": "Resources exists to turn vague doubts into clearer decisions.",
  "¿Mi marca se ve menos profesional que mi servicio?": "Does my brand look less professional than my service?",
  "¿Mi web informa, pero no convierte?": "Does my website inform but not convert?",
  "¿Mi equipo repite tareas que un sistema podría resolver?": "Does my team repeat tasks a system could solve?",
  "¿Mi espacio físico comunica el nivel real del negocio?": "Does my physical space communicate the real level of the business?",
  "Experiencia digital": "Digital experience",
  "¿Hay una pregunta que se repite en tu empresa?": "Is there a question that keeps repeating in your company?",
  "Puede ser señal de marca, web, operación o experiencia. Podemos ayudarte a encontrar la ruta.": "It may be a brand, web, operations or experience signal. We can help you find the path.",
  "Explorar guías": "Explore guides",
  "Diseñamos marcas, webs y sistemas para negocios que necesitan avanzar con más foco.": "We design brands, websites and systems for businesses that need sharper momentum.",
  "Elev8 une criterio creativo, diseño digital y ejecución práctica.": "Elev8 brings creative judgment, digital design and practical execution together.",
  "Trabajamos con empresas que necesitan verse mejor, vender mejor u operar con menos fricción.": "We work with companies that need to look better, sell better or operate with less friction.",
  "Estrategia cuando falta foco. Diseño cuando falta forma. Tecnología cuando falta flujo.": "Strategy when focus is missing. Design when form is missing. Technology when flow is missing.",
  "Menos ruido.": "Less noise.",
  "Web": "Web",
  "Espacio": "Space",
  "Una forma simple de trabajar.": "A simple way to work.",
  "Antes de producir, elegimos qué problema vale la pena resolver.": "Before producing, we choose which problem is worth solving.",
  "Leer": "Read",
  "Elegir": "Choose",
  "Medir": "Measure",
  "Qué pasa y dónde duele.": "What is happening and where it hurts.",
  "Qué mover primero.": "What to move first.",
  "La pieza que falta.": "The missing piece.",
  "Sin perder consistencia.": "Without losing consistency.",
  "Qué aprende el sistema.": "What the system learns.",
  "Qué podemos construir.": "What we can build.",
  "Cinco capacidades. Se usan solas o combinadas según el caso.": "Five capabilities. Used alone or combined depending on the case.",
  "Decisiones antes de inversión.": "Decisions before investment.",
  "Identidad, voz y presencia.": "Identity, voice and presence.",
  "Webs y productos útiles.": "Useful websites and products.",
  "Automatización aplicada.": "Applied automation.",
  "Espacios y puntos reales.": "Spaces and real touchpoints.",
  "Si no sabes qué pedir, parte por la situación.": "If you do not know what to ask for, start with the situation.",
  "Las rutas traducen problemas de negocio en próximos pasos concretos.": "Paths turn business problems into concrete next steps.",
  "Marca, web y mensaje mínimo para salir bien.": "Brand, web and minimum message to launch well.",
  "Presencia actualizada para vender con más confianza.": "Updated presence to sell with more trust.",
  "Marca, web, operación y experiencia bajo una misma lógica.": "Brand, web, operations and experience under one logic.",
  "Menos tareas repetidas y más flujo operativo.": "Fewer repeated tasks and more operational flow.",
  "Señalética, gráfica y presencia física coherente.": "Signage, graphics and coherent physical presence.",
  "Reconoce el punto de partida.": "Recognize the starting point.",
  "Cinco señales comunes. Una conversación posible.": "Five common signals. One possible conversation.",
  "Estoy lanzando algo nuevo.": "I am launching something new.",
  "La empresa creció, pero la marca no.": "The company grew, but the brand did not.",
  "La web no explica ni convierte.": "The website does not explain or convert.",
  "El equipo opera con demasiado trabajo manual.": "The team runs on too much manual work.",
  "El espacio físico no representa la marca.": "The physical space does not represent the brand.",
  "Lo que construimos.": "What we build.",
  "Servicios es el catálogo de capacidades de Elev8.": "Services is Elev8's capability catalog.",
  "Aquí está el “qué”. Si buscas el “por dónde empiezo”, entra por Soluciones.": "This is the “what”. If you need the “where do I start”, go to Solutions.",
  "Cada área puede vivir sola. El valor aparece cuando se combina con intención.": "Each area can stand alone. The value appears when it is combined with intention.",
  "Cinco áreas, usos distintos.": "Five areas, different uses.",
  "Elige una capacidad cuando ya sabes qué necesitas construir.": "Choose a capability when you already know what you need to build.",
  "Define foco, oportunidad y orden de inversión.": "Defines focus, opportunity and investment order.",
  "Construye identidad, tono, contenido y presencia.": "Builds identity, tone, content and presence.",
  "Diseña sitios, interfaces y plataformas que se entienden.": "Designs websites, interfaces and platforms people understand.",
  "Reduce trabajo manual con flujos, IA e integraciones.": "Reduces manual work with flows, AI and integrations.",
  "Lleva la marca a señalética, espacios y soportes físicos.": "Brings the brand into signage, spaces and physical supports.",
  "Combinaciones útiles": "Useful combinations",
  "No todo proyecto necesita todo.": "Not every project needs everything.",
  "Cuando el problema es verse bien y convertir mejor.": "When the problem is looking sharper and converting better.",
  "Cuando el equipo necesita procesos más livianos.": "When the team needs lighter processes.",
  "Cuando la marca también debe sentirse en el espacio.": "When the brand also needs to be felt in space.",
  "¿Ya sabes qué construir?": "Do you already know what to build?",
  "Entra por una capacidad. Si todavía no está claro, entra por una solución.": "Enter through a capability. If it is not clear yet, enter through a solution.",
  "Ver soluciones": "View solutions",
  "Elige la situación que necesitas resolver.": "Choose the situation you need to solve.",
  "Cinco rutas para decisiones que suelen llegar mezcladas.": "Five paths for decisions that usually arrive tangled.",
  "Parte por el problema. Después definimos si conviene marca, web, automatización, espacio o una mezcla más precisa.": "Start with the problem. Then we define whether brand, web, automation, space or a sharper mix makes sense.",
  "Elige la entrada más cercana. El alcance se ordena después.": "Choose the closest entry point. Scope gets organized after.",
  "Cinco situaciones comunes.": "Five common situations.",
  "Si una de estas frases se parece a tu momento, esa es una buena entrada.": "If one of these lines sounds like your moment, it is a good entry point.",
  "Una entrada por cada tipo de problema.": "One entry point for each kind of problem.",
  "Cada ruta resume señales, alcance probable y próximos pasos.": "Each path summarizes signals, likely scope and next steps.",
  "Frases que escuchamos seguido.": "Lines we hear often.",
  "Si una suena familiar, ya tenemos por dónde empezar.": "If one sounds familiar, we already have a place to start.",
  "De señal a plan.": "From signal to plan.",
  "Contexto breve, alcance claro y siguiente paso.": "Brief context, clear scope and the next step.",
  "¿Cuál situación se parece más a la tuya?": "Which situation is closest to yours?",
  "Entra por ahí. Si ninguna calza, escríbenos y ordenamos la ruta.": "Start there. If none fits, write to us and we will shape the path.",
  "Ideas útiles antes de invertir.": "Useful ideas before investing.",
  "Contenido para detectar señales, comparar opciones y decidir con más calma.": "Content to spot signals, compare options and decide with more calm.",
  "Casos, guías y diagnósticos breves. Sin biblioteca infinita.": "Cases, guides and short diagnostics. No endless library.",
  "Lee para decidir, no para acumular pestañas abiertas.": "Read to decide, not to collect open tabs.",
  "Tres decisiones frecuentes.": "Three frequent decisions.",
  "Lecturas prácticas para preparar una conversación de proyecto.": "Practical reads to prepare a project conversation.",
  "Preguntas que suelen abrir proyectos.": "Questions that often open projects.",
  "Si una se repite dentro de la empresa, probablemente hay una oportunidad de mejora.": "If one keeps repeating inside the company, there is probably room to improve.",
  "¿Tienes una pregunta concreta?": "Do you have a concrete question?",
  "Escríbenos el contexto. Te diremos si conviene diagnóstico, guía o proyecto.": "Send us the context. We will tell you whether diagnosis, guide or project makes sense.",
  "Un estudio pequeño para problemas que cruzan marca, web y operación.": "A small studio for problems that cross brand, web and operations.",
  "Trabajamos cuando una sola pieza no alcanza.": "We work when one piece is not enough.",
  "Algunas veces falta una web. Otras, una identidad. Muchas, una forma más inteligente de conectar todo.": "Sometimes what is missing is a website. Sometimes identity. Often, a smarter way to connect everything.",
  "Diseño con mirada de negocio.": "Design with a business lens.",
  "Somos más útiles cuando el problema mezcla percepción, experiencia y operación.": "We are most useful when the problem mixes perception, experience and operations.",
  "Marca + web + sistemas": "Brand + web + systems",
  "Nos interesan los proyectos donde la forma afecta el negocio.": "We care about projects where form affects the business.",
  "Elev8 trabaja entre estrategia, creatividad y tecnología aplicada.": "Elev8 works between strategy, creativity and applied technology.",
  "Una empresa puede tener buen producto y aun así comunicar poco, vender mal o perder tiempo por procesos torpes.": "A company can have a good product and still communicate poorly, sell badly or waste time through clumsy processes.",
  "Ahí entramos: no para decorar, sino para resolver cómo se ve, se entiende y funciona.": "That is where we come in: not to decorate, but to solve how it looks, reads and works.",
  "Preferimos alcances claros, etapas cortas y decisiones que se puedan explicar.": "We prefer clear scope, short stages and decisions that can be explained.",
  "A veces eso termina en marca. A veces en web, automatización, contenido, señalética o una combinación.": "Sometimes that becomes brand. Sometimes web, automation, content, signage or a combination.",
  "Menos promesa.": "Less promise.",
  "Más oficio, más foco, mejor uso.": "More craft, more focus, better use.",
  "Principios de trabajo.": "Working principles.",
  "Pocos, prácticos y fáciles de exigirnos.": "Few, practical and easy to hold us to.",
  "Mirar antes de proponer.": "Look before proposing.",
  "El contexto define el alcance.": "Context defines scope.",
  "Elegir antes de producir.": "Choose before producing.",
  "Diseñar para uso real.": "Design for real use.",
  "Lo bonito debe soportar operación, venta y equipo.": "Beauty must support operations, sales and teams.",
  "Dejar base, no dependencia.": "Leave a base, not dependency.",
  "Proceso base.": "Base process.",
  "El detalle cambia por proyecto. La secuencia no.": "Details change by project. The sequence does not.",
  "Contexto": "Context",
  "Entrega": "Delivery",
  "Qué existe, qué duele y qué está en juego.": "What exists, what hurts and what is at stake.",
  "Qué entra, qué queda fuera y por qué.": "What is included, what is left out and why.",
  "Forma, contenido, interfaz o experiencia.": "Form, content, interface or experience.",
  "Producción cuidada y lista para uso.": "Careful production, ready to use.",
  "Si cruza marca, web, contenido, automatización o espacio, probablemente podemos ayudar.": "If it crosses brand, web, content, automation or space, we can probably help.",
  "Cuéntanos qué quieres cambiar y qué existe hoy.": "Tell us what you want to change and what exists today.",
  "No necesitas un brief perfecto. Necesitamos contexto suficiente para responder con criterio.": "You do not need a perfect brief. We need enough context to answer with judgment.",
  "El primer mensaje debe ahorrar tiempo.": "The first message should save time.",
  "Mientras más concreta sea la situación, mejor podemos recomendar una ruta, una capacidad o una primera etapa.": "The more concrete the situation, the better we can recommend a path, a capability or a first stage.",
  "Contacto — Contexto — Alcance — Próximo paso": "Contact — Context — Scope — Next step",
  "Cuatro señales bastan para empezar bien.": "Four signals are enough to start well.",
  "Sirve para proponer un alcance realista desde el inicio.": "It helps us propose a realistic scope from the start.",
  "Respondemos con una recomendación inicial o una pregunta clave.": "We answer with an initial recommendation or one key question.",
  "Qué pasa después.": "What happens next.",
  "Tres pasos simples para no convertir el inicio en una reunión eterna.": "Three simple steps so the start does not become an endless meeting.",
  "Leemos": "We read",
  "Respondemos": "We reply",
  "Definimos": "We define",
  "Revisamos necesidad, contexto y urgencia.": "We review need, context and urgency.",
  "Te sugerimos una entrada o pedimos una conversación breve.": "We suggest an entry point or ask for a short conversation.",
  "Aterrizamos alcance, etapas y próximos pasos.": "We define scope, stages and next steps.",
  "No. Basta con explicar qué quieres cambiar y qué existe hoy.": "No. Just explain what you want to change and what exists today.",
  "¿Puedo pedir solo una parte?": "Can I ask for only one part?",
  "Sí. Podemos entrar por marca, web, automatización, contenido o espacio físico.": "Yes. We can enter through brand, web, automation, content or physical space.",
  "¿Qué pasa si no sé qué necesito?": "What if I do not know what I need?",
  "Describe el problema. Nosotros proponemos la entrada más lógica.": "Describe the problem. We will suggest the most logical entry point.",
  "Lo que normalmente incluye esta página.": "What this page usually includes.",
  "Cómo avanza.": "How it moves.",
  "Una secuencia corta desde contexto hasta algo listo para usar.": "A short sequence from context to something ready to use.",
  "Úsala cuando...": "Use it when...",
  "Trabajo": "Work",
  "Acerca": "About",
  "Ideas": "Insights",
  "Navegación": "Navigation",
  "Sistema Elev8": "Elev8 System",
  "Sin atajos visuales. Sin sistemas inconexos.": "No visual shortcuts. No disconnected systems.",
  "Elev8 crea continuidad entre estrategia, forma y ejecución.": "Elev8 creates continuity between strategy, form and execution.",
  "Eleveight / Elevate": "Eleveight / Elevate",
  "Estrategia / Diseño / Tecnología / Ejecución": "Strategy / Design / Technology / Execution",
  "Elevamos cómo los negocios se ven, funcionan y crecen.": "We elevate how businesses look, work and grow.",
  "Elevamos cómo los negocios": "We elevate how businesses",
  "se ven, funcionan y crecen.": "look, work and grow.",
  "Elevamos cómo tu negocio": "We elevate how your business",
  "se ve, funciona y crece.": "looks, works and grows.",
  "Elevamos cómo": "We elevate how",
  "tu negocio se ve,": "your business looks,",
  "funciona y crece.": "works and grows.",
  "Estrategia, marca, digital, inteligencia y espacio conectados bajo una misma dirección.": "Strategy, brand, digital, intelligence and space connected under one direction.",
  "Unimos estrategia, marca, sitios web, automatización y espacios para ayudarte a avanzar con claridad.": "We connect strategy, brand, websites, automation and spaces so your business can move forward with clarity.",
  "Explorar trabajo": "Explore work",
  "Ver proyectos": "View projects",
  "El 8 ordena continuidad: ver, construir, conectar y volver a mejorar sin perder dirección.": "The 8 organizes continuity: see, build, connect and improve again without losing direction.",
  "Capabilities": "Capabilities",
  "Cinco capacidades. Una dirección.": "Five capabilities. One direction.",
  "Podemos trabajar en una necesidad específica o conectar varias áreas para resolver un problema completo.": "We can solve one specific need or connect several areas to move a larger problem forward.",
  "Aclaramos qué hacer, qué priorizar y cómo avanzar.": "We clarify what to do, what to prioritize and how to move forward.",
  "Creamos o mejoramos la identidad y la forma en que tu negocio se presenta.": "We create or improve your identity and how your business presents itself.",
  "Sitios web": "Websites",
  "Diseñamos sitios claros, modernos y pensados para informar o vender.": "We design clear, modern websites built to inform or sell.",
  "Hacemos que tareas repetitivas puedan realizarse de forma automática.": "We make repetitive tasks happen automatically.",
  "Espacios": "Spaces",
  "Llevamos tu marca a oficinas, locales, señalética y otros espacios físicos.": "We bring your brand into offices, stores, signage and other physical spaces.",
  "Conocer este servicio": "Explore this service",
  "No vendemos piezas aisladas. Elegimos la combinación que el negocio necesita para avanzar.": "We do not sell isolated pieces. We choose the combination the business needs to move forward.",
  "Dirección, posicionamiento y decisiones antes de invertir en piezas.": "Direction, positioning and decisions before investing in pieces.",
  "Identidad, voz, contenido y sistemas visuales con criterio.": "Identity, voice, content and visual systems with judgment.",
  "Sitios, productos e interfaces que explican, convierten y escalan.": "Sites, products and interfaces that explain, convert and scale.",
  "Automatización, IA e integraciones para reducir fricción operativa.": "Automation, AI and integrations to reduce operational friction.",
  "Presencia física, señalética y soportes para que la marca exista fuera de pantalla.": "Physical presence, signage and supports so the brand exists beyond the screen.",
  "Selected Work": "Selected Work",
  "Trabajo seleccionado, todavía en construcción.": "Selected work, still in progress.",
  "Hasta tener casos reales publicados, usamos proyectos placeholder para diseñar el sistema editorial.": "Until real cases are published, placeholder projects help design the editorial system.",
  "Sistema de marca + web": "Brand system + web",
  "Dirección visual + contenido": "Visual direction + content",
  "Producto digital + automatización": "Digital product + automation",
  "Problems / Solutions": "Problems / Solutions",
  "Entramos por el problema, no por la lista de servicios.": "We enter through the problem, not the service list.",
  "El punto de partida define la arquitectura: marca, web, IA, espacio o una solución integrada.": "The starting point defines the architecture: brand, web, AI, space or an integrated solution.",
  "La marca se ve menor que el negocio.": "The brand looks smaller than the business.",
  "La web informa, pero no convierte.": "The website informs, but does not convert.",
  "El equipo opera con tareas repetidas.": "The team runs on repeated tasks.",
  "La experiencia física no acompaña.": "The physical experience does not keep up.",
  "Conversión": "Conversion",
  "Flujo": "Flow",
  "Continuidad": "Continuity",
  "Un sistema para elevar sin desconectar.": "A system for elevation without disconnection.",
  "El 8 funciona como método: continuidad entre estrategia, forma, tecnología, operación y experiencia.": "The 8 works as method: continuity between strategy, form, technology, operations and experience.",
  "Conectar": "Connect",
  "Detectar tensión real.": "Spot real tension.",
  "Definir qué mueve valor.": "Define what moves value.",
  "Crear el sistema visible.": "Create the visible system.",
  "Unir canales, herramientas y equipo.": "Connect channels, tools and team.",
  "Dejar base para crecer.": "Leave a base for growth.",
  "Cuando todo necesita avanzar junto.": "When everything needs to move together.",
  "Para empresas que necesitan alinear percepción, sitio web, contenido, automatización y presencia física bajo una misma lógica.": "For companies that need to align perception, website, content, automation and physical presence under one logic.",
  "Ver ruta 360": "View 360 path",
  "Prueba sobria, hasta tener casos reales.": "Quiet proof, until real cases exist.",
  "La confianza no debería depender de claims inflados. Por ahora, mostramos principios verificables.": "Trust should not depend on inflated claims. For now, we show verifiable principles.",
  "Estrategia + ejecución en un mismo equipo.": "Strategy + execution in one team.",
  "Diseño pensado para uso real, no sólo presentación.": "Design made for real use, not just presentation.",
  "Sistemas que pueden crecer por etapas.": "Systems that can grow in stages.",
  "Cuéntanos qué necesita elevarse.": "Tell us what needs to be elevated.",
  "No necesitas un brief perfecto. Necesitamos contexto suficiente para detectar la ruta correcta.": "You do not need a perfect brief. We need enough context to detect the right path.",
};
